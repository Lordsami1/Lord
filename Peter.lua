...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S Peter -X kill
screen -S Peter ./Peter
done
]])
Run:close()
...
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=Peter,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(Peter.."Peter:DevelopersQ:Groups",UserId) 
if UserId == 2076385185 then
Status = true
elseif UserId == 2061769984 then
Status = true
...
Status = 0
Developers = Redis:sismember(Peter.."Peter:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(Peter.."Peter:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(Peter.."Peter:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(Peter.."Peter:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(Peter.."Peter:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(Peter.."Peter:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(Peter.."Peter:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 2061769984 then
Status = 'Ace'
elseif UserId == 2076385185 then
Status = 'Ace'
elseif UserId == Sudo_Id then  
Status = 'Dev'
elseif UserId == Peter then
...
Status = Redis:get(Peter.."Peter:Developer:Bot:Reply"..ChatId) or 'Master'
elseif TheBasics then
Status = Redis:get(Peter.."Peter:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(Peter.."Peter:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(Peter.."Peter:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(Peter.."Peter:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(Peter.."Peter:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Peter.."Peter:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Peter.."Peter:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(Peter.."Peter:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(Peter.."Peter:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(Peter.."Peter:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(Peter.."Peter:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(Peter.."Peter:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(Peter.."Peter:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(Peter.."Peter:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Peter.."Peter:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(Peter.."Peter:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Peter.."Peter:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(Peter.."Peter:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(Peter.."Peter:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(Peter.."Peter:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(Peter.."Peter:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(Peter.."Peter:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(Peter.."Peter:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(Peter.."Peter:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(Peter.."Peter:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(Peter.."Peter:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Peter.."Peter:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(Peter.."Peter:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(Peter.."Peter:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(Peter.."Peter:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(Peter.."Peter:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(Peter.."Peter:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(Peter.."Peter:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(Peter.."Peter:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(Peter.."Peter:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(Peter.."Peter:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(Peter.."Peter:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(Peter.."Peter:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(Peter.."Peter:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(Peter.."Peter:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(Peter.."Peter:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(Peter.."Peter:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(Peter.."Peter:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(Peter.."Peter:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(Peter.."Peter:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(Peter.."Peter:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(Peter.."Peter:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(Peter.."Peter:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(Peter.."Peter:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(Peter.."Peter:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(Peter.."Peter:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(Peter.."Peter:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(Peter.."Peter:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(Peter.."Peter:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(Peter.."Peter:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(Peter.."Peter:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(Peter.."Peter:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(Peter.."Peter:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Peter.."Peter:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(Peter.."Peter:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(Peter.."Peter:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Peter.."Peter:SilentGroup:Group"..ChatId,UserId)
}
end
...
JoinChannel = true
local Channel = Redis:get(Peter..'Peter:Channel:Join')
if Channel then
...
Redis:incr(Peter..'Peter:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == 2076385185 then
msg.Name_Controller = 'Dev '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 2061769984 then
msg.Name_Controller = 'Dev'
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'Dev'
elseif Redis:sismember(Peter.."Peter:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'Master 🎖️'
elseif Redis:sismember(Peter.."Peter:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Peter.."Peter:Developer:Bot:Reply"..msg.chat_id) or 'Master'
elseif Redis:sismember(Peter.."Peter:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Peter.."Peter:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Peter.."Peter:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Peter.."Peter:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(Peter.."Peter:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Peter.."Peter:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Peter.."Peter:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Peter.."Peter:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Peter.."Peter:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Peter.."Peter:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Peter) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Peter.."Peter:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Peter.."Peter:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Peter.."Peter:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local date =  "\n ساعة دخول : "..os.date("%Y/%m/%d")
local time = "\n وقت دخول : "..os.date("%I:%M%p")
local Welcome = Redis:get(Peter.."Peter:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Peter.."Peter:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Peter) then
return false
end
local floods = Redis:hget(Peter.."Peter:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(Peter.."Peter:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Peter.."Peter:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Peter.."Peter:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Peter.."Peter:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Peter.."Peter:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(Peter.."Peter:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(Peter.."Peter:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(Peter.."Peter:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(Peter.."Peter:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Peter.."Peter:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Peter.."Peter:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Peter.."Peter:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Peter.."Peter:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(Peter.."Peter:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Peter.."Peter:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(Peter.."Peter:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(Peter.."Peter:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(Peter.."Peter:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Peter.."Peter:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(Peter.."Peter:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Peter.."Peter:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Peter.."Peter:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(Peter.."Peter:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(Peter.."Peter:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(Peter.."Peter:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(Peter.."Peter:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(Peter.."Peter:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(Peter.."Peter:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(Peter.."Peter:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(Peter.."Peter:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Peter.."Peter:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(Peter.."Peter:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(Peter.."Peter:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Peter.."Peter:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(Peter.."Peter:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(Peter.."Peter:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(Peter.."Peter:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(Peter.."Peter:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(Peter.."Peter:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Peter..'Peter:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Peter.."Peter:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Peter.."Peter:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Peter.."Peter:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Peter.."Peter:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Peter.."Peter:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Peter.."Peter:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Peter.."Peter:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(Peter.."Peter:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Peter..'Peter:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n• ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(Peter..'Peter:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(Peter.."Peter:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Peter.."Peter:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Peter.."Peter:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(Peter..'Peter:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(Peter..'Peter:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Peter.."Peter:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Peter.."Peter:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Peter.."Peter:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Peter.."Peter:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Peter.."Peter:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Peter.."Peter:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Peter.."Peter:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Peter.."Peter:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Peter..'Peter:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(Peter.."Peter:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(Peter.."Peter:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Peter.."Peter:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Peter.."Peter:Command:List:Group"..msg_chat_id,text)
...
Redis:del(Peter.."Peter:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Peter.."Peter:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Peter.."Peter:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Peter.."Peter:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Peter.."Peter:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"• ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Peter.."Peter:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Peter.."Peter:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Peter.."Peter:Command:List:Group"..msg_chat_id,text)
Redis:del(Peter.."Peter:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ الامر باسم ←  "..text..' ',"md",true)
end
if Redis:get(Peter.."Peter:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(Peter.."Peter:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(Peter.."Peter:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(Peter.."Peter:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:del(Peter.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Peter.."Peter:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(Peter.."Peter:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Peter.."Peter:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(Peter.."Peter:Group:Rules" .. msg_chat_id,text) 
Redis:del(Peter.."Peter:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(Peter.."Peter:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Peter.."Peter:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(Peter.."Peter:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(Peter.."Peter:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Peter.."Peter:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Peter.."Peter:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Peter.."Peter:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Peter.."Peter:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(Peter.."Peter:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Peter.."Peter:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(Peter.."Peter:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(Peter.."Peter:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(Peter.."Peter:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(Peter.."Peter:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ رد للمدير بنجاح \n• ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(Peter.."Peter:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Peter.."Peter:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Peter.."Peter:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Peter.."Peter:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Peter.."Peter:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Peter.."Peter:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Peter.."Peter:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Peter.."Peter:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Peter.."Peter:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Peter.."Peter:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Peter.."Peter:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Peter.."Peter:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(Peter.."Peter:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = 'Source Peter', url='https://t.me/VV6YV'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(Peter.."Peter:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Peter.."Peter:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Peter.."Peter:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Peter.."Peter:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Peter.."Peter:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Peter.."Peter:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Peter.."Peter:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Peter.."Peter:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"• تم حذف الرد من الردود ","md",true)  
return false
end
end
if text and Redis:get(Peter.."Peter:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(Peter.."Peter:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Peter.."Peter:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Peter.."Peter:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(Peter.."Peter:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Peter.."Peter:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(Peter.."Peter:Add:Rd:Sudo:Video"..text)
local document = Redis:get(Peter.."Peter:Add:Rd:Sudo:File"..text)
local audio = Redis:get(Peter.."Peter:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(Peter.."Peter:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Peter..'Peter:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Peter..'Peter:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(Peter.."Peter:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(Peter.."Peter:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Peter.."Peter:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Peter.."Peter:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(Peter.."Peter:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Peter.."Peter:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(Peter.."Peter:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(Peter.."Peter:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Peter.."Peter:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(Peter.."Peter:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Peter..'Peter:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(Peter.."Peter:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Peter.."Peter:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Peter.."Peter:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Peter.."Peter:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Peter.."Peter:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(Peter.."Peter:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Peter.."Peter:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(Peter.."Peter:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Peter.."Peter:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(Peter.."Peter:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(Peter.."Peter:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(Peter.."Peter:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(Peter.."Peter:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Peter.."Peter:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Peter.."Peter:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Peter.."Peter:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Peter.."Peter:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(Peter..'Peter:'..v..text)
end
Redis:del(Peter.."Peter:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Peter.."Peter:List:Rd:Sudo", text)
...
local list = Redis:smembers(Peter.."Peter:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Peter.."Peter:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Peter.."Peter:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(Peter..'Peter:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Peter.."Peter:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Peter.."Peter:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Peter.."Peter:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Peter.."Peter:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Peter.."Peter:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Peter.."Peter:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Peter.."Peter:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(Peter..'Peter:GetTexting:DevPeter'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر •' then 
Redis:del(Peter..'Peter:GetTexting:DevPeter'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'• تم الغاء حفظ كليشة Dev')
end
Redis:set(Peter..'Peter:Texting:DevPeter',text)
Redis:del(Peter..'Peter:GetTexting:DevPeter'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'• تم حفظ كليشة Dev')
end
if Redis:get(Peter.."Peter:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء امر تعين الايدي","md",true)  
Redis:del(Peter.."Peter:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Peter.."Peter:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Peter.."Peter:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(Peter.."Peter:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Peter.."Peter:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Peter.."Peter:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(Peter.."Peter:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "• تم تغير اسم البوت الى • "..text,"md",true)    
end 
if Redis:get(Peter.."Peter:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Peter.."Peter:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Peter.."Peter:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Peter.."Peter:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "• تم تغيير كليشه start • "..text,"md",true)    
end 
if Redis:get(Peter.."Peter:Game:Smile"..msg.chat_id) then
if text == Redis:get(Peter.."Peter:Game:Smile"..msg.chat_id) then
Redis:incrby(Peter.."Peter:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Peter.."Peter:Game:Smile"..msg.chat_id)
...
if Redis:get(Peter.."Peter:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Peter.."Peter:Game:Monotonous"..msg.chat_id) then
Redis:del(Peter.."Peter:Game:Monotonous"..msg.chat_id)
Redis:incrby(Peter.."Peter:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Peter.."Peter:Game:Riddles"..msg.chat_id) then
if text == Redis:get(Peter.."Peter:Game:Riddles"..msg.chat_id) then
Redis:incrby(Peter.."Peter:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Peter.."Peter:Game:Riddles"..msg.chat_id)
...
if Redis:get(Peter.."Peter:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Peter.."Peter:Game:Meaningof"..msg.chat_id) then
Redis:incrby(Peter.."Peter:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Peter.."Peter:Game:Meaningof"..msg.chat_id)
...
if Redis:get(Peter.."Peter:Game:Reflection"..msg.chat_id) then
if text == Redis:get(Peter.."Peter:Game:Reflection"..msg.chat_id) then
Redis:incrby(Peter.."Peter:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Peter.."Peter:Game:Reflection"..msg.chat_id)
...
if Redis:get(Peter.."Peter:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"• عذرآ لا يمكنك تخمين عدد اكبر من ال  20  خمن رقم ما بين ال 1 و 20 \n","md",true)  
end 
local GETNUM = Redis:get(Peter.."Peter:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Peter.."Peter:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Peter.."Peter:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Peter.."Peter:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"• مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸|تم اضافة  5  من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Peter.."Peter:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Peter.."Peter:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Peter.."Peter:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Peter.."Peter:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Peter.."Peter:Game:Difference"..msg.chat_id) then
if text == Redis:get(Peter.."Peter:Game:Difference"..msg.chat_id) then 
Redis:del(Peter.."Peter:Game:Difference"..msg.chat_id)
Redis:incrby(Peter.."Peter:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Peter.."Peter:Game:Example"..msg.chat_id) then
if text == Redis:get(Peter.."Peter:Game:Example"..msg.chat_id) then 
Redis:del(Peter.."Peter:Game:Example"..msg.chat_id)
Redis:incrby(Peter.."Peter:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(Peter..'Peter:Channel:Join:Name')..'', url = 't.me/'..Redis:get(Peter..'Peter:Channel:Join')}, },}}
...
Y = Y + 1
Redis:sadd(Peter..'Peter:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Peter.."Peter:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Peter.."Peter:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Peter.."Peter:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Peter.."Peter:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Peter.."Peter:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Peter.."Peter:Distinguished:Group"..GroupId,v)
end
end 
end
...
Redis:sadd(Peter.."Peter:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Peter.."Peter:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Peter.."Peter:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Peter.."Peter:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Peter.."Peter:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(Peter..'Peter:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر •' then 
Redis:del(Peter..'Peter:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,Peter).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n• البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(Peter..'Peter:Channel:Join',ChannelUser) 
Redis:set(Peter..'Peter:Channel:Join:Name',UserId_Info.title) 
...
Redis:set(Peter..'Peter:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Peter..'Peter:Channel:Join')
...
--os.execute('rm -rf Peter.lua')
--download('https://raw.githubusercontent.com/SourcePeter/Peter/master/Peter.lua','Peter.lua')
...
local Groups = Redis:smembers(Peter..'Peter:ChekBotAdd')  
local UsersBot = Redis:smembers(Peter..'Peter:Num:User:Pv')  
...
local President = Redis:smembers(Peter.."Peter:TheBasics:Group"..v)
local Constructor = Redis:smembers(Peter.."Peter:Originators:Group"..v)
local Manager = Redis:smembers(Peter.."Peter:Managers:Group"..v)
local Admin = Redis:smembers(Peter.."Peter:Addictive:Group"..v)
local Vips = Redis:smembers(Peter.."Peter:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(Peter.."Peter:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(Peter.."Peter:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(Peter.."Peter:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(Peter.."Peter:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(Peter.."Peter:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(Peter.."Peter:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(Peter.."Peter:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(Peter.."Peter:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(Peter.."Peter:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(Peter.."Peter:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(Peter.."Peter:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(Peter.."Peter:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(Peter.."Peter:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(Peter.."Peter:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(Peter.."Peter:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(Peter.."Peter:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(Peter.."Peter:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(Peter.."Peter:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(Peter.."Peter:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(Peter.."Peter:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(Peter.."Peter:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(Peter..'Peter:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'• عدد احصائيات البوت الكامله \n━━━━━\n• عدد المجموعات : '..(Redis:scard(Peter..'Peter:ChekBotAdd') or 0)..'\n• عدد المشتركين : '..(Redis:scard(Peter..'Peter:Num:User:Pv') or 0)..'',"md",true)  
end
...
if Redis:sismember(Peter.."Peter:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Peter..'Peter:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'• عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Peter..'Peter:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(Peter.."Peter:ChekBotAdd",msg_chat_id)
Redis:set(Peter.."Peter:Status:Id"..msg_chat_id,true) ;Redis:set(Peter.."Peter:Status:Reply"..msg_chat_id,true) ;Redis:set(Peter.."Peter:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Peter.."Peter:Status:BanId"..msg_chat_id,true) ;Redis:set(Peter.."Peter:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Peter.."Peter:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Peter.."Peter:ChekBotAdd",msg_chat_id) then
...
Redis:srem(Peter.."Peter:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Peter.."Peter:ChekBotAdd",msg_chat_id) then
if text == "ايدي" and msg.reply_to_message_id == 0 then
if not Redis:get(Peter.."Peter:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(Peter..'Peter:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Peter..'Peter:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Peter.."Peter:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Peter.."Peter:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {""}
...
Get_Is_Id = Redis:get(Peter.."Peter:Set:Id:Group"..msg_chat_id)
if Redis:get(Peter.."Peter:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(Peter..'Peter:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(Peter..'Peter:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n• ID 𖦹 '..UserId..
'\n• UserName 𖦹 '..UserInfousername..
...
local TotalMsg = Redis:get(Peter..'Peter:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(Peter..'Peter:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n• ID 𖦹 '..UserId..
'\n• UserName 𖦹 @'..UserName..
...
if (Redis:get(Peter.."Peter:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Peter.."Peter:AddSudosNew"..msg_chat_id)
...
Redis:set(Peter.."Peter:AddSudosNew"..msg_chat_id,true)
...
if not Redis:sismember(Peter.."Peter:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله مسبقا Master 🎖 ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(Peter.."Peter:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله Master مسبقا ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:Developers:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله Master ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Peter.."Peter:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Peter.."Peter:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Peter.."Peter:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Peter.."Peter:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Peter.."Peter:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Peter.."Peter:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Peter.."Peter:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Peter.."Peter:Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Peter.."Peter:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله Master ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Peter.."Peter:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Peter.."Peter:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Peter.."Peter:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Peter.."Peter:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Peter.."Peter:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Peter.."Peter:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Peter.."Peter:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Peter.."Peter:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Peter.."Peter:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Peter.."Peter:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Peter.."Peter:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله مسبقا Master 🎖 ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(Peter.."Peter:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله Master مسبقا ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:Developers:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله Master ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Peter.."Peter:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Peter.."Peter:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Peter.."Peter:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Peter.."Peter:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Peter.."Peter:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Peter.."Peter:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مسبقا Master 🎖 ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(Peter.."Peter:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته C مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(Peter.."Peter:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Peter.."Peter:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Peter.."Peter:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Peter.."Peter:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(Peter.."Peter:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Peter.."Peter:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Peter.."Peter:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Peter.."Peter:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Peter.."Peter:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته C مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Peter.."Peter:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Peter.."Peter:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Peter.."Peter:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Peter.."Peter:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Peter.."Peter:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Peter.."Peter:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Peter.."Peter:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته Master 🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(Peter.."Peter:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته C مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Developers:Groups",UserId) 
...
if Redis:sismember(Peter.."Peter:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Peter.."Peter:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Peter.."Peter:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Peter.."Peter:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Peter.."Peter:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(Peter.."Peter:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(Peter.."Peter:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Peter.."Peter:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Peter.."Peter:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(Peter.."Peter:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Peter.."Peter:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(Peter.."Peter:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(Peter.."Peter:Developers:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Peter.."Peter:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Peter.."Peter:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Peter.."Peter:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Peter.."Peter:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Peter.."Peter:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Peter.."Peter:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Peter.."Peter:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Peter.."Peter:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Peter.."Peter:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Peter.."Peter:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(Peter.."Peter:Status:Id"..msg_chat_id,true) 
...
Redis:set(Peter.."Peter:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(Peter.."Peter:Status:Reply"..msg_chat_id,true) 
...
Redis:set(Peter.."Peter:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(Peter.."Peter:Status:BanId"..msg_chat_id,true) 
...
Redis:set(Peter.."Peter:BotFree",true) 
...
Redis:set(Peter.."Peter:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(Peter.."Peter1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(Peter.."Peter1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Peter.."Peter1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Peter.."Peter1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Peter.."Peter1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(Peter..'Peter1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(Peter..'Peter1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(Peter..'Peter1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(Peter.."Peter1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Peter.."Peter1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(Peter.."Peter1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(Peter.."Peter1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(Peter.."Peter1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(Peter.."Peter1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(Peter.."Peter1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(Peter.."Peter1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(Peter.."Peter1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Peter.."Peter1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Peter.."Peter1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Peter.."Peter1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Peter.."Peter1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Peter.."Peter1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Peter.."Peter1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Peter.."Peter1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Peter.."Peter1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Peter.."Peter1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Peter.."Peter1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Peter.."Peter1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Peter.."Peter1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(Peter.."Peter1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(Peter.."Peter1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(Peter.."Peter1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(Peter.."Peter:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(Peter.."Peter:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Peter.."Peter:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Peter.."Peter:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(Peter.."Peter:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(Peter..'Peter:Add:Rd:Sudo:Text'..text)
Redis:del(Peter..'Peter1:Add:Rd:Sudo:Text1'..text)
Redis:del(Peter..'Peter:Add:Rd:Sudo:Text2'..text)
Redis:del(Peter.."Peter:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Peter.."Peter:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(Peter.."Peter:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(Peter.."Peter:Add:Rd:Sudo:Text"..v) 
Redis:del(Peter.."Peter1:Add:Rd:Sudo:Text1"..v) 
Redis:del(Peter.."Peter:Add:Rd:Sudo:Text2"..v)   
Redis:del(Peter.."Peter:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(Peter.."Peter:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(Peter.."Peter:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Peter.."Peter:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Peter.."Peter:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Peter.."Peter:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = Redis:get(Peter.."Peter:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Peter.."Peter:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Peter.."Peter:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Peter.."Peter1:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(Peter.."Peter:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Peter.."Peter:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Peter.."Peter:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Peter.."Peter:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(Peter.."Peter1:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(Peter.."Peter1:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(Peter.."Peter1:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(Peter.."Peter:allM"..msg.chat_id, msg.id)
if Redis:get(Peter.."Peter:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(Peter.."Peter:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(Peter.."Peter:allM"..msg.chat_id)
...
Redis:del(Peter.."Peter:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(Peter.."Peter:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(Peter.."Peter:allM"..msg.chat_id)  
...
Redis:del(Peter.."Peter:Status:Del:Media"..msg.chat_id)
...
Redis:set(Peter.."Peter:Status:Del:Media"..msg.chat_id,true)
...
{{text = '- Source Peter .',url="t.me/VV6YV"}},
}
...
Rink = 1
elseif Redis:sismember(Peter.."Peter:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Peter.."Peter:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Peter.."Peter:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Peter.."Peter:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Peter.."Peter:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Peter.."Peter:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Peter.."Peter:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Peter.."Peter:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Peter.."Peter:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Peter.."Peter:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
local TextingDevPeter = Redis:get(Peter..'Texting:DevPeter')
...
if Redis:get(Peter.."lockalllll"..msg_chat_id) == "off" then
...
{
{text = '❲ SourceManger ❳', url = "https://t.me/YY6VY"}
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,"[Source Peter](t.me/VV6YV)\n\n[Source Manger](t.me/YY6VY)","md",true, false, false, false,reply_markup)
end
if text == 'تعطيل التحقق' then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص : ( '..Controller_Num(7)..' ) ',"md",true)  
end
Redis:del(Peter.."Peter:Status:joinet"..msg_chat_id) 
...
Redis:set(Peter.."Peter:Status:joinet"..msg_chat_id,true) 
...
if TextMsg == 'الرابط' then
Redis:del(Peter.."Peter:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Peter.."Peter:Status:Welcome"..msg_chat_id) 
...
Redis:del(Peter.."Peter:Status:Id"..msg_chat_id) 
...
Redis:del(Peter.."Peter:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Peter.."Peter:Status:Reply"..msg_chat_id) 
...
Redis:del(Peter.."Peter:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Peter.."Peter:Status:BanId"..msg_chat_id) 
...
Redis:del(Peter.."Peter:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(Peter.."Peter:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(Peter.."Peter:Status:KickMe"..msg_chat_id) 
...
Redis:del(Peter.."Peter:TwaslBot") 
...
if Redis:sismember(Peter.."Peter:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Peter.."Peter:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Peter.."Peter:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(Peter.."Peter:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Peter.."Peter:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(Peter.."Peter:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(Peter.."Peter:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(Peter.."Peter:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Peter.."Peter:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(Peter.."Peter:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(Peter.."Peter:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(Peter.."Peter:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Peter.."Peter:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Peter.."Peter:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Peter.."Peter:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Peter.."Peter:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Peter.."Peter:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Peter.."Peter:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Peter.."Peter:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Peter.."Peter:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Peter.."Peter:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Peter.."Peter:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Peter.."Peter:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(Peter.."Peter:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(Peter.."Peter:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(Peter.."Peter:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Peter.."Peter:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(Peter.."Peter:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(Peter.."Peter:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Peter.."Peter:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(Peter.."Peter:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Peter.."Peter:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Peter.."Peter:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(Peter.."Peter:Lock:text"..msg_chat_id,true) 
...
Redis:set(Peter.."Peter:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Peter.."Peter:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Peter.."Peter:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Peter.."Peter:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Peter.."Peter:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Peter.."Peter:Lock:edit"..msg_chat_id,true) 
...
Redis:set(Peter.."Peter:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Peter..'Peter:'..lock..msg_chat_id,"del")    
end
...
Redis:del(Peter.."Peter:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Peter.."Peter:Lock:text"..msg_chat_id)  
...
Redis:del(Peter.."Peter:Lock:Join"..msg_chat_id)  
...
Redis:del(Peter.."Peter:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Peter.."Peter:Lock:tagservr"..msg_chat_id)  
...
Redis:del(Peter.."Peter:lockpin"..msg_chat_id)  
...
Redis:del(Peter.."Peter:Lock:edit"..msg_chat_id) 
...
Redis:del(Peter.."Peter:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Peter..'Peter:'..lock..msg_chat_id)    
end
...
Redis:hset(Peter.."Peter:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Peter.."Peter:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Peter.."Peter:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Peter.."Peter:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Peter.."Peter:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Peter.."Peter:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:Link"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:User:Name"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:hashtak"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:Cmd"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:Photo"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:Video"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:Animation"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:geam"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:Audio"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:vico"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:Sticker"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:forward"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:Document"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:Contact"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:Spam"..msg_chat_id)  
...
Redis:set(Peter.."Peter:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Peter.."Peter:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Peter.."Peter:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Peter.."Peter:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Peter.."Peter:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Peter.."Peter:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(Peter.."Peter:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(Peter.."Peter:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(Peter.."Peter:Group:Link"..msg_chat_id) 
if GetLink then
...
if not Redis:get(Peter.."Peter:Status:Welcome"..msg_chat_id) then
...
Redis:del(Peter.."Peter:Welcome:Group"..msg_chat_id) 
...
Redis:setex(Peter.."Peter:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(Peter.."Peter:Group:Rules"..msg_chat_id) 
...
local Rules = Redis:get(Peter.."Peter:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Peter.."Peter:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Peter.."Peter:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(Peter.."Peter:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Peter.."Peter:Filter:Group:"..v..msg_chat_id)  
Redis:srem(Peter.."Peter:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Peter.."Peter:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(Peter..'Peter:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(Peter..'Peter:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n• ارسل الان  ملصق ,متحركه ,صوره ,رساله  ',"md",true)  
end
...
Redis:set(Peter.."Peter:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Peter.."Peter:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Peter.."Peter:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Peter.."Peter:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(Peter.."Peter:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(Peter.."Peter:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(Peter.."Peter:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(Peter.."Peter:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(Peter.."Peter:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(Peter.."Peter:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(Peter.."Peter:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(Peter.."Peter:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(Peter.."Peter:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(Peter.."Peter:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(Peter.."Peter:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '- قناة السورس', url = 't.me/VV6YV'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(Peter.."Peter:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Peter.."Peter:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(Peter.."Peter:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Peter.."Peter:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Peter.."Peter:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Peter.."Peter:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(Peter.."Peter:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(Peter.."Peter:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(Peter.."Peter:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(Peter.."Peter:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(Peter.."Peter:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(Peter.."Peter:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(Peter..'Peter:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'• تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(Peter..'Peter:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'• تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Peter..'Peter:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'• تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'• عدد رسائلك هنا •'..(Redis:get(Peter..'Peter:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'• عدد التعديلات هنا •'..(Redis:get(Peter..'Peter:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'• عدد جهاتك المضافه هنا •'..(Redis:get(Peter.."Peter:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'',"md",true)  
...
Redis:setex(Peter.."Peter:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
• ارسل الان النص
• يمكنك اضافه :
...
Redis:del(Peter.."Peter:Set:Id:Group"..msg.chat_id)
...
Redis:del(Peter.."Peter:DevelopersQ:Groups") 
...
Redis:del(Peter.."Peter:Developers:Groups") 
...
Redis:del(Peter.."Peter:TheBasics:Group"..msg_chat_id) 
...
Redis:del(Peter.."Peter:Originators:Group"..msg_chat_id) 
...
Redis:del(Peter.."Peter:Managers:Group"..msg_chat_id) 
...
Redis:del(Peter.."Peter:Addictive:Group"..msg_chat_id) 
...
Redis:del(Peter.."Peter:Distinguished:Group"..msg_chat_id) 
...
Redis:del(Peter.."Peter:BanAll:Groups") 
...
Redis:del(Peter.."Peter:BanGroup:Group"..msg_chat_id) 
...
Redis:del(Peter.."Peter:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(Peter.."Peter:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Peter.."Peter:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Peter.."Peter:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Peter.."Peter:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(Peter.."Peter:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Peter.."Peter:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Peter.."Peter:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Peter.."Peter:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Peter.."Peter:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Peter.."Peter:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Peter.."Peter:List:Manager"..msg_chat_id)
end
...
text = "• قائمه الردود \n━━━━━\n"
for k,v in pairs(list) do
if Redis:get(Peter.."Peter:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف • "
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(Peter.."Peter:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » ( "..v.." ) » ( "..db.." )\n"
end
...
Redis:set(Peter.."Peter:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Peter.."Peter:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(Peter.."Peter:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Peter.."Peter:Add:Rd:Sudo:Gif"..v)   
Redis:del(Peter.."Peter:Add:Rd:Sudo:vico"..v)   
Redis:del(Peter.."Peter:Add:Rd:Sudo:stekr"..v)     
Redis:del(Peter.."Peter:Add:Rd:Sudo:Text"..v)   
Redis:del(Peter.."Peter:Add:Rd:Sudo:Photo"..v)
Redis:del(Peter.."Peter:Add:Rd:Sudo:Video"..v)
Redis:del(Peter.."Peter:Add:Rd:Sudo:File"..v)
Redis:del(Peter.."Peter:Add:Rd:Sudo:Audio"..v)
Redis:del(Peter.."Peter:Add:Rd:Sudo:video_note"..v)
Redis:del(Peter.."Peter:List:Rd:Sudo")
end
...
text = "\n📝|قائمة الردود العامه \n━━━━━\n"
for k,v in pairs(list) do
if Redis:get(Peter.."Peter:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(Peter.."Peter:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(Peter.."Peter:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(Peter.."Peter:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(Peter.."Peter:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(Peter.."Peter:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(Peter.."Peter:Add:Rd:Sudo:File"..v) then
db = "ملف • "
elseif Redis:get(Peter.."Peter:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(Peter.."Peter:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » ( "..v.." ) » ( "..db.." )\n"
end
...
Redis:set(Peter.."Peter:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Peter.."Peter:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(Peter.."Peter:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯|ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Peter.."Peter:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯|ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Peter.."Peter:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Peter.."Peter:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Peter..'Peter:GetTexting:DevPeter'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Peter..'Peter:Texting:DevPeter')
...
Redis:setex(Peter.."Peter:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Peter.."Peter:Name:Bot") 
...
x = x + 1
Redis:srem(Peter..'Peter:Num:User:Pv',v)
end
end
if x ~= 0 then
...
Redis:srem(Peter..'Peter:ChekBotAdd',Get_Chat.id)
...
Redis:srem(Peter..'Peter:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(Peter.."Peter:Game:Smile"..msg.chat_id,SM)
...
Redis:set(Peter.."Peter:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(Peter.."Peter:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Peter.."Peter:Status:Games"..msg.chat_id) then
Redis:del(Peter.."Peter:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Peter.."Peter:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Peter.."Peter:Status:Games"..msg.chat_id) then
Redis:del(Peter.."Peter:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Peter.."Peter:Game:Reflection"..msg.chat_id,name)
...
Redis:set(Peter.."Peter:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Peter.."Peter:Game:Difference"..msg.chat_id,name)
...
Redis:set(Peter.."Peter:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Peter.."Peter:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Peter.."Peter:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Peter.."Peter:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Peter.."Peter:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(Peter.."Peter:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(Peter.."Peter:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(Peter.."Peter:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع')
...
if text == '/start' then
Redis:sadd(Peter..'Peter:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(Peter.."Peter:Start:Bot") then
local CmdStart = '\n• أهلآ بك في بوت '..(Redis:get(Peter.."Peter:Name:Bot") or "Peter")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Peter.."Peter:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(Peter.."Peter:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Peter.."Peter:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(Peter.."Peter:TwaslBot") and not Redis:sismember(Peter.."Peter:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Peter.."Peter:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Peter.."Peter:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Peter..'Peter:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'• تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Peter..'Peter:BaN:In:Tuasl',Info_User)  
...
Redis:srem(Peter.."Peter:ChekBotAdd",'-100'..data.supergroup.id)
...
if Redis:get(Peter.."Peter:Lock:tagservr"..data.message.chat_id) then
...
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Peter..'Peter:Status:joinet'..data.message.chat_id) == 'true' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:incr(Peter..'Peter:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Peter.."Peter:Lock:edit"..data.chat_id) then
...
Redis:srem(Peter.."Peter:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(Peter.."Peter:BanGroup:Group"..ChatId,listYt[2]) 
...
Redis:del(Peter.."Peter:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(Peter.."Peter1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(Peter.."Peter:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Peter.."Peter:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Peter.."Peter:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Peter.."Peter1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Peter.."Peter:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"• ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Peter.."Peter:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"• ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(Peter.."Peter:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Peter.."Peter:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Peter.."Peter:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Peter.."Peter:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Peter.."Peter:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Peter.."Peter:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Peter.."Peter:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Peter.."Peter:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Peter.."Peter:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Peter..'Peter:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Peter.."Peter:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"• تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Peter.."Peter:SilentGroup:Group"..ChatId) 
